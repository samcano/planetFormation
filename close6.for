...
c Write encounter details to appropriate files
     ...
     %        t1,id(jclo),dclo,x1(1),x1(2),x1(3),v1(1),v1(2),v1(3),
     %        x2(1),x2(2),x2(3),v2(1),v2(2),v2(3),m(iclo),m(jclo)
c
            if (unit(jclo).ge.10) write (unit(jclo),fout) year,month,
     %        t1,id(iclo),dclo,x1(1),x1(2),x1(3),v1(1),v1(2),v1(3),
     %        x2(1),x2(2),x2(3),v2(1),v2(2),v2(3),m(iclo),m(jclo)
          else
            if (unit(iclo).ge.10) write (unit(iclo),fout) t1,id(jclo),
     %        dclo,x1(1),x1(2),x1(3),v1(1),v1(2),v1(3),
     %        x2(1),x2(2),x2(3),v2(1),v2(2),v2(3),m(iclo),m(jclo)
...
c
      if (timestyle.eq.0.or.timestyle.eq.2) then
        ...
        header(20:58) = '  Object   dmin (AU)     x1       y1    '
        header(59:90) = '   z1      vx1      vy1      vz1'
        header(91:122) = '   x2       y2       z2      vx2'
        header(123:154) = '  vy2      vz2       m1       m2'
        lenhead = 154
        fout = '(1x,f18.5,1x,a8,1x,e18.8,7(1x,e18.8,1x,e18.8))'
      else
        if (timestyle.eq.1) then
